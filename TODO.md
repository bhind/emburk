...
`T-0013/S04` is `In Progress`; `T-0012`, `T-0021` and all other unfinished items
...
| T-0013 | Specify lifecycle, transaction, cleanup, and resume semantics (S04: selected live empty-lifecycle comparison) | In Progress | P0 | 13 | T-0011 | Compatibility Host Implementer | Differential (Embulk) |
