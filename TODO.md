...
`T-0013/S07` and `T-0021/S05` are integrated. T-0012, T-0013, T-0021 and all
other unfinished items are `Backlog`; T-0013/S08 is prepared. No item is
`Blocked`. Combined active WIP is zero of two until activation.
...
| T-0013 | Specify lifecycle, transaction, cleanup, and resume semantics (S08: commit-position comparison prepared) | Backlog | P0 | 34 | T-0011 | Compatibility Host Implementer | Differential (Embulk) |
...
T-0013/S08 (3 SP within unchanged Current 34 / Initial 8) is prepared under its
