...
T-0026/S01 is Done through PR #136 (`8577ffd`).
...
T-0014/S03 is Done through PR #139 (`5cea0b4`), accepting 3 SP after
primary and independent final-head agreement across three bounded multi-file
File input observations and thirteen focused tests. Parent #17 remains Backlog;
Initial 8 is unchanged and Current is 11.
...
T-0031/S02 is Done through PR #112 (`2ec236e`) for experimental stdout/null targets,
accepting 3 SP after primary and independent final-head Demo at `c5df504`.
...
| T-0014 | Scaffold the differential harness (S01–S03 Done) | Backlog | P0 | 11 | T-0012, T-0013 | Compatibility Host Implementer | Differential (Embulk) |
...
| T-0026 | Implement structured errors and observability (S01 Done) | Backlog | P1 | 5 | T-0021 | Rust Core Implementer | Unit/Contract |
...
| T-0032 | Implement the CSV parser and formatter (S01/S02/S03 Done; S04 Stage B In Progress; remaining contracts queued) | Backlog | P1 | 21 | T-0023 | Rust Core Implementer | Differential (Embulk) |
...
T-0032/S04 is an active 5 SP bounded lexical Float64 File/CSV follow-on under
...
`3.5`/`42.0` output. Stage B has no public surface or new dependency and must
preserve ADR-0026 while rejecting every other unselected Float64 lexical value
before final publication. Parent T-0032 remains Backlog at Current 21 / Initial
8; this forecast is not parent completion evidence.
