...
No item is `Blocked`; no implementation lane is active during the serial handoff.
...
| T-0012 | Specify configuration, schema, and value semantics (S08 integrated; S09 double observation prepared) | Backlog | P0 | 34 | T-0011 | Compatibility Host Implementer | Differential (Embulk) |
