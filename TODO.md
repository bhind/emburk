...
Current queue state: `T-0002`, `T-0003`, and `T-0011` are `Done`; `T-0004` and
`T-0021` are `In Progress`; `T-0012` is `Blocked`; and every other item is
...
| T-0004 | Implement Project synchronization audit | In Progress | P1 | 5 | T-0002, T-0003 | Project Manager | Unit/Contract |
