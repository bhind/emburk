...
T-0013/S07 (`Ready`) is the next serial work item. Combined active WIP is zero of
...
| T-0013/S07 | Ready | Observe first/middle commit failures before choosing Rust policy |
