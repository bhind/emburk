...
Stage B is active but not integrated. It must preserve the ADR-0026 profile and
reject unselected lexical values before final publication. It is not a general
