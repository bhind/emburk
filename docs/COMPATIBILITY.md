...
row omission. ADR-0026 authorizes native work at that exact boundary; no native
`double` profile is integrated or verified yet, and no wider numeric behavior is
claimed.
